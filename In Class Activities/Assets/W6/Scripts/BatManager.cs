...
public class BatManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            float Distance = Vector3.Distance(bat.GetComponent<Transform>().position, _playerTransform.position);
    ...
    private void CreateReactions(BatW6 bat)
    {
        ...
        //      of CreateReactions.
        int msgIndex = Random.Range(0, _messages.Length);
        SpawnReactionUI(bat, _messages[msgIndex]);
        // STEP 5 -------------------------------------------------------------
    }
