...
public class MuskratW7 : MonoBehaviour
{
    ...
    private void MoveOrbitMode()
    {
        ...
        Vector3 axis1 = transform.TransformDirection(Vector3.up);
        transform.RotateAround(_sphereTransform.position, axis1, leftright * _rotationSpeed * Time.deltaTime);
    ...
    private void MoveNormal()
    {
        ...
        float leftright = Input.GetAxis("Horizontal");
        transform.Rotate(Vector3.up, _rotationSpeed * leftright * Time.deltaTime);
        ...
        Vector3 axis = movement * Vector3.forward * _moveSpeed * Time.deltaTime;
        ...
        if (Mathf.Abs(_rigidbody.linearVelocity.y) >= 0.02)
        {
